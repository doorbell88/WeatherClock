...
# unicode circle ( for terminalClock() )
#_circle = str(unichr(11044).encode('utf-8'))
#circle = deepcopy(_circle)
circle = 'o'
    ...
    def set_12_Hours(self, display_type):
        ...
        for i in range(number_of_LEDs):
            ...
            if i == 0:
                ...
                self.setHour(HOUR_12, 'cursor', 'cursor', display_type)
            #LedHandler.setLEDBrightness(HOUR_12, 0.955**i)
